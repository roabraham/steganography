<?php
    /**
     * @file
     * Advanced Encryption Standard (AES) for PHP
    ...
    class AES {
        ...
        public function __construct($z, $mode = 'CBC', $iv = null) {
            ...
            if ($this->mode != 'ECB' && strlen($this->iv) != 16) {
                throw new Exception('The initialization vector must be 128 bits (or 16 characters) long.');
            }
        ...
        public function decrypt($y) {
            ...
            switch ($this->mode) {
                ...
                case 'OFB': $x = $this->encrypt($y); break;
            }
